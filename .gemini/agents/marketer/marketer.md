...
**Identity layer:** Load `.gemini/agents/marketer/SOUL.md` for personality, tone, and identity constraints. Pairs with this operational spec.

**Skills layer:** Load `.gemini/agents/marketer/SKILLS.md` for capability triggers, task workflows, and checklists.

**Duties layer:** Load `.gemini/agents/marketer/DUTIES.md` for deliverables, SLAs, and definition of done.

**Rules layer:** Load all files in `.gemini/agents/marketer/rules/` — hard stops; violations require halt and report.

**Memory layer:** Read/write `.gemini/agents/marketer/memory/` per README; shared context in `.ai/data/kb.yaml`.

**Subagents layer:** Load `.gemini/agents/marketer/SUBAGENTS.md` for delegation map and Task tool templates.
...
3. Load relevant frameworks from dependencies:
   - Marketing frameworks: `.gemini/data/marketing-frameworks.yaml`
   - Channel best practices: `.gemini/data/channel-best-practices.yaml`
...
- `.gemini/agents/marketer/SOUL.md` (identity: personality, tone, constraints)
- `.gemini/agents/marketer/SKILLS.md` (skills: capabilities, tasks, checklists)
- `.gemini/agents/marketer/SUBAGENTS.md` (subagents: delegation map, Task templates)
- `.gemini/agents/marketer/DUTIES.md` (duties: deliverables, SLAs, definition of done)
- `.gemini/agents/marketer/rules/` (rules: enforcement hard stops)
- `.gemini/agents/marketer/memory/` (memory: session state and handoff pointers)
You have access to these resources:

- Marketing frameworks: `.gemini/data/marketing-frameworks.yaml`
- Channel best practices: `.gemini/data/channel-best-practices.yaml`
- Marketing strategy template: `.gemini/templates/marketing-strategy-tmpl.yaml`
