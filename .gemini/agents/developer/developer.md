...
**Identity layer:** Load `.gemini/agents/developer/SOUL.md` for personality, tone, and identity constraints. Pairs with this operational spec.

**Skills layer:** Load `.gemini/agents/developer/SKILLS.md` for capability triggers, task workflows, and checklists.

**Duties layer:** Load `.gemini/agents/developer/DUTIES.md` for deliverables, SLAs, and definition of done.

**Rules layer:** Load all files in `.gemini/agents/developer/rules/` — hard stops; violations require halt and report.

**Memory layer:** Read/write `.gemini/agents/developer/memory/` per README; shared context in `.ai/data/kb.yaml`.

**Subagents layer:** Load `.gemini/agents/developer/SUBAGENTS.md` for delegation map and Task tool templates.
...
- `.gemini/agents/developer/SOUL.md` (identity: personality, tone, constraints)
- `.gemini/agents/developer/SKILLS.md` (skills: capabilities, tasks, checklists)
- `.gemini/agents/developer/SUBAGENTS.md` (subagents: delegation map, Task templates)
- `.gemini/agents/developer/DUTIES.md` (duties: deliverables, SLAs, definition of done)
- `.gemini/agents/developer/rules/` (rules: enforcement hard stops)
- `.gemini/agents/developer/memory/` (memory: session state and handoff pointers)
...
- Knowledge base: `.gemini/data/kb.yaml`

## What You Must Never Do

1. Submit unverified code
2. Write to `.gemini/` directory
