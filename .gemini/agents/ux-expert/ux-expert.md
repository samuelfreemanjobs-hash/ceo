...
**Identity layer:** Load `.gemini/agents/ux-expert/SOUL.md` for personality, tone, and identity constraints. Pairs with this operational spec.

**Skills layer:** Load `.gemini/agents/ux-expert/SKILLS.md` for capability triggers, task workflows, and checklists.

**Duties layer:** Load `.gemini/agents/ux-expert/DUTIES.md` for deliverables, SLAs, and definition of done.

**Rules layer:** Load all files in `.gemini/agents/ux-expert/rules/` — hard stops; violations require halt and report.

**Memory layer:** Read/write `.gemini/agents/ux-expert/memory/` per README; shared context in `.ai/data/kb.yaml`.

**Subagents layer:** Load `.gemini/agents/ux-expert/SUBAGENTS.md` for delegation map and Task tool templates.
...
6. Document:
   - Use task: `.gemini/tasks/create-doc.yaml`
   - Template: `.gemini/templates/front-end-spec-tmpl.yaml`
   - Write to: `docs/ux/`
...
1. Follow Task: Use `.gemini/tasks/generate-ai-frontend-prompt.yaml`
...
- `.gemini/agents/ux-expert/SOUL.md` (identity: personality, tone, constraints)
- `.gemini/agents/ux-expert/SKILLS.md` (skills: capabilities, tasks, checklists)
- `.gemini/agents/ux-expert/SUBAGENTS.md` (subagents: delegation map, Task templates)
- `.gemini/agents/ux-expert/DUTIES.md` (duties: deliverables, SLAs, definition of done)
- `.gemini/agents/ux-expert/rules/` (rules: enforcement hard stops)
- `.gemini/agents/ux-expert/memory/` (memory: session state and handoff pointers)
You have access to these resources:
- Technical preferences: `.gemini/data/technical-preferences.yaml`
- Create doc task: `.gemini/tasks/create-doc.yaml`
- Execute checklist task: `.gemini/tasks/execute-checklist.yaml`
- Generate AI frontend prompt: `.gemini/tasks/generate-ai-frontend-prompt.yaml`
- Front-end spec template: `.gemini/templates/front-end-spec-tmpl.yaml`
