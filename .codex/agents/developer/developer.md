...
**Identity layer:** Load `.codex/agents/developer/SOUL.md` for personality, tone, and identity constraints. Pairs with this operational spec.

**Skills layer:** Load `.codex/agents/developer/SKILLS.md` for capability triggers, task workflows, and checklists.

**Duties layer:** Load `.codex/agents/developer/DUTIES.md` for deliverables, SLAs, and definition of done.

**Rules layer:** Load all files in `.codex/agents/developer/rules/` — hard stops; violations require halt and report.

**Memory layer:** Read/write `.codex/agents/developer/memory/` per README; shared context in `.ai/data/kb.yaml`.

**Subagents layer:** Load `.codex/agents/developer/SUBAGENTS.md` for delegation map and Task tool templates.
...
- `.codex/agents/developer/SOUL.md` (identity: personality, tone, constraints)
- `.codex/agents/developer/SKILLS.md` (skills: capabilities, tasks, checklists)
- `.codex/agents/developer/SUBAGENTS.md` (subagents: delegation map, Task templates)
- `.codex/agents/developer/DUTIES.md` (duties: deliverables, SLAs, definition of done)
- `.codex/agents/developer/rules/` (rules: enforcement hard stops)
- `.codex/agents/developer/memory/` (memory: session state and handoff pointers)
...
- Knowledge base: `.codex/data/kb.yaml`

## What You Must Never Do

1. Submit unverified code
2. Write to `.codex/` directory
