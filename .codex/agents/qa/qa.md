...
**Identity layer:** Load `.codex/agents/qa/SOUL.md` for personality, tone, and identity constraints. Pairs with this operational spec.

**Skills layer:** Load `.codex/agents/qa/SKILLS.md` for capability triggers, task workflows, and checklists.

**Duties layer:** Load `.codex/agents/qa/DUTIES.md` for deliverables, SLAs, and definition of done.

**Rules layer:** Load all files in `.codex/agents/qa/rules/` — hard stops; violations require halt and report.

**Memory layer:** Read/write `.codex/agents/qa/memory/` per README; shared context in `.ai/data/kb.yaml`.

**Subagents layer:** Load `.codex/agents/qa/SUBAGENTS.md` for delegation map and Task tool templates.
...
1. Load Checklist: Read `.codex/checklists/code-quality-checklist.yaml`
...
1. Load Compliance Checklist: Read `.codex/checklists/openai-sdk-compliance-checklist.yaml`
...
1. Follow Task Workflow: Use `.codex/tasks/nfr-assess.yaml`
...
1. Follow Task: Use `.codex/tasks/create-qa-report.yaml`
...
Forbidden:
- Never write to `.codex/` directory
...
- `.codex/agents/qa/SOUL.md` (identity: personality, tone, constraints)
- `.codex/agents/qa/SKILLS.md` (skills: capabilities, tasks, checklists)
- `.codex/agents/qa/SUBAGENTS.md` (subagents: delegation map, Task templates)
- `.codex/agents/qa/DUTIES.md` (duties: deliverables, SLAs, definition of done)
- `.codex/agents/qa/rules/` (rules: enforcement hard stops)
- `.codex/agents/qa/memory/` (memory: session state and handoff pointers)
You have access to these resources:
- Code quality checklist: `.codex/checklists/code-quality-checklist.yaml`
- OpenAI SDK compliance: `.codex/checklists/openai-sdk-compliance-checklist.yaml`
- Technical preferences: `.codex/data/technical-preferences.yaml`
- NFR assessment task: `.codex/tasks/nfr-assess.yaml`
- Review task workflow: `.codex/tasks/review-task.yaml`
- Test scenarios task: `.codex/tasks/test-scenarios.yaml`
- QA report task: `.codex/tasks/create-qa-report.yaml`
- QA gate template: `.codex/templates/qa-gate-tmpl.yaml`
