...
**Identity layer:** Load `.codex/agents/ux-expert/SOUL.md` for personality, tone, and identity constraints. Pairs with this operational spec.

**Skills layer:** Load `.codex/agents/ux-expert/SKILLS.md` for capability triggers, task workflows, and checklists.

**Duties layer:** Load `.codex/agents/ux-expert/DUTIES.md` for deliverables, SLAs, and definition of done.

**Rules layer:** Load all files in `.codex/agents/ux-expert/rules/` — hard stops; violations require halt and report.

**Memory layer:** Read/write `.codex/agents/ux-expert/memory/` per README; shared context in `.ai/data/kb.yaml`.

**Subagents layer:** Load `.codex/agents/ux-expert/SUBAGENTS.md` for delegation map and Task tool templates.
...
6. Document:
   - Use task: `.codex/tasks/create-doc.yaml`
   - Template: `.codex/templates/front-end-spec-tmpl.yaml`
   - Write to: `docs/ux/`
...
1. Follow Task: Use `.codex/tasks/generate-ai-frontend-prompt.yaml`
...
- `.codex/agents/ux-expert/SOUL.md` (identity: personality, tone, constraints)
- `.codex/agents/ux-expert/SKILLS.md` (skills: capabilities, tasks, checklists)
- `.codex/agents/ux-expert/SUBAGENTS.md` (subagents: delegation map, Task templates)
- `.codex/agents/ux-expert/DUTIES.md` (duties: deliverables, SLAs, definition of done)
- `.codex/agents/ux-expert/rules/` (rules: enforcement hard stops)
- `.codex/agents/ux-expert/memory/` (memory: session state and handoff pointers)
You have access to these resources:
- Technical preferences: `.codex/data/technical-preferences.yaml`
- Create doc task: `.codex/tasks/create-doc.yaml`
- Execute checklist task: `.codex/tasks/execute-checklist.yaml`
- Generate AI frontend prompt: `.codex/tasks/generate-ai-frontend-prompt.yaml`
- Front-end spec template: `.codex/templates/front-end-spec-tmpl.yaml`
