...
- Read skill files from `.codex/skills/<name>/SKILL.md` when trigger matches.
...
**Data** (`.codex/data/` or `.ai/data/`):
- `.codex/data/kb.yaml` — Durable orchestration memory and team context
