...
**Identity layer:** Load `.codex/agents/writer/SOUL.md` for personality, tone, and identity constraints. Pairs with this operational spec.

**Skills layer:** Load `.codex/agents/writer/SKILLS.md` for capability triggers, task workflows, and checklists.

**Duties layer:** Load `.codex/agents/writer/DUTIES.md` for deliverables, SLAs, and definition of done.

**Rules layer:** Load all files in `.codex/agents/writer/rules/` — hard stops; violations require halt and report.

**Memory layer:** Read/write `.codex/agents/writer/memory/` per README; shared context in `.ai/data/kb.yaml`.

**Subagents layer:** Load `.codex/agents/writer/SUBAGENTS.md` for delegation map and Task tool templates.
...
4. Knowledge Base Construction:
   ...
   - Follow template: `.codex/templates/knowledge-base-tmpl.yaml`
   - Write to: `docs/research/kb-[topic-slug].md`

5. Follow Task: Use `.codex/tasks/warmstart-article.yaml`
...
5. Follow Task: Use `.codex/tasks/synthesize-article.yaml`
...
5. Follow Task: Use `.codex/tasks/research-topic.yaml`

## Content Optimization Workflow

When running `*optimize`:

1. Follow Task: Use `.codex/tasks/optimize-content.yaml`
...
5. Use Checklist: `.codex/checklists/content-quality-checklist.yaml`
...
Forbidden:
- Do NOT write into `.codex/` directory
...
- `.codex/agents/writer/SOUL.md` (identity: personality, tone, constraints)
- `.codex/agents/writer/SKILLS.md` (skills: capabilities, tasks, checklists)
- `.codex/agents/writer/SUBAGENTS.md` (subagents: delegation map, Task templates)
- `.codex/agents/writer/DUTIES.md` (duties: deliverables, SLAs, definition of done)
- `.codex/agents/writer/rules/` (rules: enforcement hard stops)
- `.codex/agents/writer/memory/` (memory: session state and handoff pointers)
You have access to these resources:
- Core config: `.codex/core-config.yaml`
- Agent guidelines: `.codex/AGENTS.md`
- Warmstart article task: `.codex/tasks/warmstart-article.yaml`
- Synthesize article task: `.codex/tasks/synthesize-article.yaml`
- Research topic task: `.codex/tasks/research-topic.yaml`
- Optimize content task: `.codex/tasks/optimize-content.yaml`
- Content quality checklist: `.codex/checklists/content-quality-checklist.yaml`
- Technical preferences: `.codex/data/technical-preferences.yaml`
- Knowledge base data: `.codex/data/kb.yaml`
- Knowledge base template: `.codex/templates/knowledge-base-tmpl.yaml`
- Coverage report template: `.codex/templates/coverage-report-tmpl.yaml`
