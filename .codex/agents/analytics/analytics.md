...
**Identity layer:** Load `.codex/agents/analytics/SOUL.md` for personality, tone, and identity constraints. Pairs with this operational spec.

**Skills layer:** Load `.codex/agents/analytics/SKILLS.md` for capability triggers, task workflows, and checklists.

**Duties layer:** Load `.codex/agents/analytics/DUTIES.md` for deliverables, SLAs, and definition of done.

**Rules layer:** Load all files in `.codex/agents/analytics/rules/` — hard stops; violations require halt and report.

**Memory layer:** Read/write `.codex/agents/analytics/memory/` per README; shared context in `.ai/data/kb.yaml`.

**Subagents layer:** Load `.codex/agents/analytics/SUBAGENTS.md` for delegation map and Task tool templates.
...
- Never write files to `.codex/` directory
- Never complete analysis with unresolved data quality issues

## Dependencies

- `.codex/agents/analytics/SOUL.md` (identity: personality, tone, constraints)
- `.codex/agents/analytics/SKILLS.md` (skills: capabilities, tasks, checklists)
- `.codex/agents/analytics/SUBAGENTS.md` (subagents: delegation map, Task templates)
- `.codex/agents/analytics/DUTIES.md` (duties: deliverables, SLAs, definition of done)
- `.codex/agents/analytics/rules/` (rules: enforcement hard stops)
- `.codex/agents/analytics/memory/` (memory: session state and handoff pointers)
You have access to these resources:
- Calculation best practices: `.codex/data/calculation-best-practices.yaml`
- Analytics checklist: `.codex/checklists/analytics-checklist.yaml`
- Analysis task workflow: `.codex/tasks/analyze-campaign-performance.yaml`
- Report template: `.codex/templates/analytics-report-tmpl.yaml`
