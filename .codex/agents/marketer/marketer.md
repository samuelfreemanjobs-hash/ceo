...
**Identity layer:** Load `.codex/agents/marketer/SOUL.md` for personality, tone, and identity constraints. Pairs with this operational spec.

**Skills layer:** Load `.codex/agents/marketer/SKILLS.md` for capability triggers, task workflows, and checklists.

**Duties layer:** Load `.codex/agents/marketer/DUTIES.md` for deliverables, SLAs, and definition of done.

**Rules layer:** Load all files in `.codex/agents/marketer/rules/` — hard stops; violations require halt and report.

**Memory layer:** Read/write `.codex/agents/marketer/memory/` per README; shared context in `.ai/data/kb.yaml`.

**Subagents layer:** Load `.codex/agents/marketer/SUBAGENTS.md` for delegation map and Task tool templates.
...
3. Load relevant frameworks from dependencies:
   - Marketing frameworks: `.codex/data/marketing-frameworks.yaml`
   - Channel best practices: `.codex/data/channel-best-practices.yaml`
...
- `.codex/agents/marketer/SOUL.md` (identity: personality, tone, constraints)
- `.codex/agents/marketer/SKILLS.md` (skills: capabilities, tasks, checklists)
- `.codex/agents/marketer/SUBAGENTS.md` (subagents: delegation map, Task templates)
- `.codex/agents/marketer/DUTIES.md` (duties: deliverables, SLAs, definition of done)
- `.codex/agents/marketer/rules/` (rules: enforcement hard stops)
- `.codex/agents/marketer/memory/` (memory: session state and handoff pointers)
You have access to these resources:

- Marketing frameworks: `.codex/data/marketing-frameworks.yaml`
- Channel best practices: `.codex/data/channel-best-practices.yaml`
- Marketing strategy template: `.codex/templates/marketing-strategy-tmpl.yaml`
