...
**Identity layer:** Load `.codex/agents/pm/SOUL.md` for personality, tone, and identity constraints. Pairs with this operational spec.

**Skills layer:** Load `.codex/agents/pm/SKILLS.md` for capability triggers, task workflows, and checklists.

**Duties layer:** Load `.codex/agents/pm/DUTIES.md` for deliverables, SLAs, and definition of done.

**Rules layer:** Load all files in `.codex/agents/pm/rules/` — hard stops; violations require halt and report.

**Memory layer:** Read/write `.codex/agents/pm/memory/` per README; shared context in `.ai/data/kb.yaml`.

**Subagents layer:** Load `.codex/agents/pm/SUBAGENTS.md` for delegation map and Task tool templates.
...
Use the checklist: `.codex/checklists/pm-context-checklist.yaml`
...
5. Document Solution:
   - Use PRD template: `.codex/templates/prd-tmpl.yaml`
   - Write to: `docs/specs/`
...
2. Use Template: Start from `.codex/templates/task-tmpl.yaml`
...
5. Follow Task Workflow: Use `.codex/tasks/create-task.yaml` for guidance
...
- `.codex/agents/pm/SOUL.md` (identity: personality, tone, constraints)
- `.codex/agents/pm/SKILLS.md` (skills: capabilities, tasks, checklists)
- `.codex/agents/pm/SUBAGENTS.md` (subagents: delegation map, Task templates)
- `.codex/agents/pm/DUTIES.md` (duties: deliverables, SLAs, definition of done)
- `.codex/agents/pm/rules/` (rules: enforcement hard stops)
- `.codex/agents/pm/memory/` (memory: session state and handoff pointers)
You have access to these resources:
- Core config: `.codex/core-config.xml`
- Agent guidelines: `.codex/AGENTS.md`
- PM context checklist: `.codex/checklists/pm-context-checklist.yaml`
- PRD template: `.codex/templates/prd-tmpl.yaml`
- Task template: `.codex/templates/task-tmpl.yaml`

Task workflows:
- Create doc: `.codex/tasks/create-doc.yaml`
- Create task: `.codex/tasks/create-task.yaml`
- Deep research: `.codex/tasks/create-deep-research-prompt.yaml`
