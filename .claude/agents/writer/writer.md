...
**Skills layer:** Load `.claude/agents/writer/SKILLS.md` for capability triggers, task workflows, and checklists.

**Duties layer:** Load `.claude/agents/writer/DUTIES.md` for deliverables, SLAs, and definition of done.

**Rules layer:** Load all files in `.claude/agents/writer/rules/` — hard stops; violations require halt and report.

**Memory layer:** Read/write `.claude/agents/writer/memory/` per README; shared context in `.ai/data/kb.yaml`.

**Subagents layer:** Load `.claude/agents/writer/SUBAGENTS.md` for delegation map and Task tool templates.
...
- `.claude/agents/writer/SKILLS.md` (skills: capabilities, tasks, checklists)
- `.claude/agents/writer/SUBAGENTS.md` (subagents: delegation map, Task templates)
- `.claude/agents/writer/DUTIES.md` (duties: deliverables, SLAs, definition of done)
- `.claude/agents/writer/rules/` (rules: enforcement hard stops)
- `.claude/agents/writer/memory/` (memory: session state and handoff pointers)
