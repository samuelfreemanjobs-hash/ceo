...
display_name: Casey
layer_type: duties
pairs_with: .claude/agents/writer/writer.md
...
> Accountability layer for Content & Research Writer. Defines *what must get done*, deliverables, and escalation — not how (see `writer.md`) or who (see `SOUL.md`).
